...
WP_TB_BASIC_CRAWLER_03 = DESIGN_APPROVED_BY_HUMAN_A0 / MICRO_A_INDEPENDENT_AUDIT_PASS
...
NEXT_PARENT_CANDIDATE = WP-TB-BASIC-CRAWLER-03
NEXT_PARENT = WP-TB-BASIC-CRAWLER-03
NEXT_WP_AUTHORIZED = NO
...
REAL_DOCX_AUTHORITY_EVIDENCE = EVIDENCE_GAP
REAL_REFERENCE_OPERATIONAL_EVIDENCE = EVIDENCE_GAP
MATERIAL_PRODUCT_BLOCKERS:
  BC03-B01 = CONTROLLED_CANDIDATE_DISCOVERY_AND_HUMAN_CONFIRMED_INTAKE
  BC03-B01_EVIDENCE = Folder input currently persists documents, memberships and workspace entries before per-file Human confirmation.
  BC03-B02 = OPERATIONAL_LATEST_REVISION_STATE_ABSENT
  BC03-B03 = FORWARD_ONLY_REVISION_TRANSITION_AND_HUMAN_MISMATCH_GATE_ABSENT
  BC03-B04 = PREVIOUS_LATEST_BOUNDED_DIFF_ABSENT
  BC03-B05 = PACKAGE_SCOPED_SHORT_MANAGED_NAMING_ABSENT
...
DOCX_ROLE_AUTHORITY = EVIDENCE_GAP
...
COMPLETION_EVIDENCE = Merged Bài 2 real TenderCase acceptance proves intake,
 ...
 export and zero cross-tender contamination. DOCX role/authority, reference
 authority separation, multi-revision operational proof and same-package
 end-to-end proof remain NOT_PROVEN and require no speculative fixture.
