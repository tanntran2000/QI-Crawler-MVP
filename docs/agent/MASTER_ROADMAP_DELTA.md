...
```text
DELTA_ID = RD-0011
STATE = HUMAN_AUTHORIZED_PARENT_IN_PROGRESS
...
ACTIVE_PARENT = WP-REL-V010-CANDIDATE-PREP-01
...
PR116_AUDIT_CORRECTION = F01_WAL_COHERENCE_AND_F02_PROVENANCE_IMPLEMENTED_PENDING_REAUDIT
