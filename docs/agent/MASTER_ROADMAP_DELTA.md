...
WP_WH_RECOVERY_01 = CLOSED_POST_MERGE_VERIFIED
NEXT_WP_AUTHORIZED = NO_NEXT_PRODUCT_WP
CURRENT_GOVERNED_NON_PRODUCT_ACTION = P0_B1_STALE_BRANCH_RECONCILIATION
PARKED != CANCELLED
```
...
RELEVANT_CURRENT_WP = NONE / HUMAN_A0_CHECKPOINT
NEXT_PARENT_CANDIDATE = NONE
NEXT_GOVERNED_NON_PRODUCT_ACTION = P0_B1_STALE_BRANCH_RECONCILIATION
...
RECOVERY_COMPLETION_EVIDENCE = PR99 merge commit
