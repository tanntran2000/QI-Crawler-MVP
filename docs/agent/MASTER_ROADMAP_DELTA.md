...
WP_TB_BASIC_CRAWLER_02 = PARENT_CLOSED_PENDING_PR_INTEGRATION
...
NEXT_PARENT_CANDIDATE = PLANNER_SELECTION_REQUIRED
NEXT_PARENT = NONE
NEXT_WP_AUTHORIZED = NO
...
WHY_IT_MATTERS = A technically correct storage backend that cannot be used in
  ...
  Backend contracts.
ROADMAP_IMPACT = ROADMAP_STATUS_UPDATE
RELEVANT_CURRENT_WP = WP-TB-BASIC-CRAWLER-02 / PARENT TERMINAL CLOSEOUT
