...
ROUTE_1_NO_SOURCE_OPEN_COPY = SOURCE_BYTE_INVARIANT_PRESERVED_BY_ABSENCE_OF_SQLITE_OPEN_ONLY; THREE_FILE_COPY_IS_NOT_ATOMIC; LIVE_WRITER_OR_CHECKPOINT_CAN_INTERLEAVE; PRE_POST_HASHES_CAN_DETECT_SOME_CHANGES_BUT_ARE_NOT_ATOMICITY_PROOF; FAIL_CLOSED_IF_BOUNDARY_OR_VALIDATION_UNPROVEN
