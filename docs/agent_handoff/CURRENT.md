...
OPEN_BLOCKERS = Parent/Micro read-mode ambiguity; Prompt Writer lacks operational read-mode selector
SCOPE_BOUNDARIES = governance/documentation only; 02B-3/runtime/persistence/GUI/API/release work prohibited
EXACTLY_ONE_NEXT_ACTION = BUILDER APPLY WP-GOV-DOC-LIFECYCLE-SYNC-1-FC1
