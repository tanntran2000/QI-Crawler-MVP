...
INDEPENDENT_TARGETED_VERIFICATION = PENDING_REVIEWER
...
PR_STATE = NO
MERGE_STATE = NO
CODE_REMOTE_CHECKPOINT = PASS_FOR_02C_2_ONLY
PUSH = NO
PR = NO
MERGE = NO
...
DOC_SYNC_STATE = MICRO_IMPLEMENTATION_HANDOFF
...
OPEN_BLOCKERS = INDEPENDENT_REVIEW_PENDING; HOSTED_CI_UNAVAILABLE_QUOTA; PENDING_RETRO_CI
...
NEXT_STATE = INDEPENDENT_REVIEW
NEXT_AUTHORITY = REVIEWER_AUDITOR
EXACTLY_ONE_NEXT_ACTION = INDEPENDENT_REVIEW_WP_MI_TBMT_02C_3
