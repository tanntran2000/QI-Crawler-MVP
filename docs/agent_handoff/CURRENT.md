...
HANDOFF_CAPTURE_BASE = fe83ab18a0a51cb7926ccd1c2a6c4144c9cd6527
...
REMOTE_CHECKPOINT = C2_LOCAL_COMMITS_PENDING_PUSH
PR_STATE = PR103_MERGED_C2_DRAFT_PR_PENDING
MERGE_STATE = PR103_MERGED_LIVE_MAIN_C2_NOT_MERGED
VERIFICATION_STATE = LOCAL_C2_FULL_1267_PASSED_710.39S_RUFF_PASS_DIFF_PASS
HOSTED_CI_STATE = PENDING_NATURAL_EXACT_HEAD
...
HANDOFF_READY = NO_PENDING_PUSH_DRAFT_PR_AND_EXACT_HEAD_CI
EXACTLY_ONE_NEXT_ACTION = PUSH_C2_BRANCH_AND_OPEN_ONE_DRAFT_PR
...
This handoff records the pre-push C2 state; live remote branch, draft PR and
natural exact-head CI remain to be verified from GitHub.
